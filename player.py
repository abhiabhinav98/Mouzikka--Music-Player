...
class Player:
    ...
    def add_song(self):
        song_path=filedialog.askopenfilename(filetypes=[("mp3 files",".mp3")],title="Select a MP3 file")
        if song_path=="":
            return
        ...
        song_length=self.get_song_length(song_name)
    ...
    def load_songs_from_favourites(self):
        result = self.my_model.load_songs_from_favourite()
